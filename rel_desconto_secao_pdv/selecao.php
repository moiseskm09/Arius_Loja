...
<div class="container-fluid">
    <section class="filtro">
        <form method="post" action="" id="formDesconto" ajax=true>
        <div class="row">
            <div class="col-12">
                <h6 class="fw-bold p-1" style="color:#1d4289;background-color: #f1be48; border-radius:8px;">Relatório de descontos por Seção e Pdv<h6>
            </div>
            ...
            <div class="col-md-2 col-12">
                <div class="form-group">
                    ...
                    <select class="form-control" name="nroLoja" id="nroLoja">
                        <option selected value="<?php if(isset($_POST["nroLoja"])){ echo $_POST["nroLoja"];}else{echo "";}?>"><?php if(isset($_POST["nroLoja"])){ echo $_POST["nroLoja"];}else{echo "Escolha a loja";}?></option>
                        <?php
            ...
            <div class="col-md-2 col-6">
                <div class="form-group">
                    ...
                    <input type="date" name="dataproc_i" class="form-control input" id="dataproc_i" value="<?php echo date("Y-m-d") ?>" required>
                </div>
            </div>
            <div class="col-md-2 col-6">
                <div class="form-group">
                    <label class="fonte">Data Final <span class="text-danger">*</span></label>
                    <input type="date" name="dataproc_f" class="form-control input" id="dataproc_f" value="<?php echo date("Y-m-d") ?>" required>
                </div>
            </div>
            <div class="col-md-2 col-12">
                <div class="form-group">
            ...
            <div class="col-md-3 col-12">
                <div class="form-group">
                    <button type="submit" class="btn btn-sm btn-success form-control"><i class="fas fa-eye"></i> Visualizar</button>
                </div>
            </div>
        </div>
        </form>
        ...
        <table class="table table-bordered dataTable fonte" id="example">
            ...
            <?php
                while($row_infoDesconto = mysqli_fetch_assoc($resultado_infoDesconto)){
                    ...
                    ?>
            <tr class="linha">
                <th class="p-1" scope="row"><?php echo date('d-m-y', strtotime($row_infoDesconto["dataproc"]))?></th>
                <td class="p-1"><?php echo $row_infoDesconto["pdv"];?></td>
                <td class="p-1"><?php echo $row_infoDesconto["secao"];?></td>
                <td class="p-1"><?php echo $row_infoDesconto["nrocupom"];?></td>
                <td class="p-1"><?php echo substr($row_infoDesconto["descr_merc"], 0, 20) ;?></td>
            ...
            <tfoot>
            <tr>
                <td class="p-1" colspan="9">Total Geral</td>
                <td><?php echo $total_quantidade; ?></td>
                <td><?php echo number_format($total_valor_unit,2,",","."); ?></td>
                <td><?php echo number_format($total_valor_unit_original,2,",","."); ?></td>
                <td><?php echo number_format($total_valor,2,",","."); ?></td>
                <td><?php echo number_format($total_original,2,",","."); ?></td>
