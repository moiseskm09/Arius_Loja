...
"- Segure o botão do mouse sobre qualquer um dos botões acima para seleção rápida.";
Calendar._TT["ABOUT_TIME"] = "\n\n" +
"Seleção da hora:\n" +
"- Clique em qualquer uma das partes da hora para adiantá-la\n" +
"- ou combinando com o botão Shift para atrasá-la\n" +
