...
function getCalendarStyles() {
	...
	result += "<STYLE>\n";
	result += "."+p+"cpYearNavigation,."+p+"cpMonthNavigation { background-color:#980F17; text-align:center; vertical-align:center; text-decoration:none; color:white; font-weight:bold; }\n";
	...
	result += "TD."+p+"cpCurrentDate { background-color:orange; }\n";
	...
	result += "A."+p+"cpTodayText { color:#CA0000; }\n";
