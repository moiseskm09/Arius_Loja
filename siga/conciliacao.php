...
<html lang="pt-br">
  <head>
	...
	<title>Painel Conciliação - Geral</title>
           <!-- Bootstrap CSS -->
...
#dimensa {
  ...
  <center>
<legend> Painel de Conciliação</legend>
</center>
            ...
            <table id="tabela" class="table table-bordered">
                ...
                <tbody>
					...
					$sql = "SELECT loja, data, dataenvio FROM conciliacao";
                    ...
                    <tr id="dimensao" style="background-color:#98FB98">
                        ...
                        <td id="dimensao" ><?php  echo date('d/m/Y', strtotime($mostrar['data'])); ?></td>
						<td id="dimensao" ><?php echo date('d/m/Y - H:i:s', strtotime($mostrar['dataenvio'])); ?></td>
						<td id="dimensao" ><?php  echo "ENVIADO" ; ?></td>
                        ...
                        <td id="dimensao" ><?php  echo  date('d/m/Y', strtotime($mostrar['data'])); ?></td>
						<td id="dimensao" ><?php echo date('d/m/Y  - H:i:s', strtotime($mostrar['dataenvio'])); ?></td>
						<td id="dimensao" ><?php  echo "PENDENTE" ; ?></td>
