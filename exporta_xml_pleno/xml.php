...
<html lang="pt-br">
    <head>
        ...
        <title>Arius - Exportação XML'S</title>
    ...
    <body>
        <div class="container-fluid">
            <div class="row row-cols-1 row-cols-md-2">
                <div class="col-md-4 mb-4 mx-auto" style="margin-top:110px;">
                    <div class="card" style="border-radius: 15px; border: 2px solid #0159b1;">
                        ...
                        <h6 class="text-center">Exportação de XML's Pleno</h6>
                        <div class="card-body">

                            <form action="exporta_pleno.php" method="POST">
                                ...
                                <?php 
                                $consultaLoja = mysqli_query($conexao, "SELECT cfg06_numero, cfg06_nome FROM cfg06_filial");
                                ...
                                <div class="input-group mb-3" >
                                    ...
                                    <select class="form-control" name="loja" required="" aria-label="loja" aria-describedby="basic-addon1">
                                       <?php while ($resultadoLoja = mysqli_fetch_assoc($consultaLoja)) { ?>
                                        <option value="<?php echo $resultadoLoja['cfg06_numero']?>"><?php echo utf8_encode($resultadoLoja['cfg06_numero']." - ".$resultadoLoja['cfg06_nome'])?></option>
                                       <?php } ?>
                                    </select>
                                </div>
                                ...
                                <input type="hidden" class="form-control" name="loja" value="<?php echo $resultadoLoja['cfg06_numero']?>" required=""> 
                                  <?php }
                                        ?>
